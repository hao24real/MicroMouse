...
int leftspeed_global;
int rightspeed_global;
...
// Set speed of left motor, this set the speed of left motor with count per 2ms
void setLeftSpeed(int32_t speed){
	leftspeed_global = speed;
	setLeftPwm(speed);
}

// Set speed of left motor, this set the speed of left motor with count per 2ms
void setRightSpeed(int32_t speed){
	rightspeed_global = speed;
	setRightPwm(speed);
}

// THIS FUNCTION CAN NOT CALL BY USER, THIS IS CALLED BY THE PID FUNCTION
// THIS WILL NOT WORK BECAUSE PID FUCTION CALL THIS EVERY 2MS
